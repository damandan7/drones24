...
def main():
    ...
    with SyncCrazyflie(URI1, cf=Crazyflie(rw_cache='./cache')) as scf1, SyncCrazyflie(URI4, cf=Crazyflie(rw_cache='./cache')) as scf4, SyncCrazyflie(URI5, cf=Crazyflie(rw_cache='./cache')) as scf5, SyncCrazyflie(URI6, cf=Crazyflie(rw_cache='./cache')) as scf6, SyncCrazyflie(URI7, cf=Crazyflie(rw_cache='./cache')) as scf7, SyncCrazyflie(URI8, cf=Crazyflie(rw_cache='./cache')) as scf8: 
        print('connecttehted')
        ...
        hlc1.go_to(0, 0, 1, 0, 2, relative=False)
        #hlc2.go_to(1, 0, 1, 0, 2, relative=False)
        #hlc3.go_to(1, -1, 1, 0, 2, relative=False)
        hlc4.go_to(0, -1, 1, 0, 2, relative=False)
        hlc5.go_to(-1, -1, 1, 0, 2, relative=False)
        hlc6.go_to(-1, 0, 1, 0, 2, relative=False)
        hlc7.go_to(-1, 1, 1, 0, 2, relative=False)
                ...
                if hand1:
                    ...
                    if hand_grabbed:
                        if distance == None:
                            ...
                            hlc4.go_to(P3[0], depth-1, P3[1], 0, 0.5, relative=False)
                            hlc5.go_to(P3[0]-1, depth-1, P3[1], 0, 0.5, relative=False)
                            hlc6.go_to(P3[0]-1, depth, P3[1], 0, 0.5, relative=False)
                            hlc7.go_to(P3[1]-1, depth+1, P3[1], 0, 0.5, relative=False)
                            hlc8.go_to(P3[1], depth+1, P3[1], 0, 0.5, relative=False)
                            ...
                            print("P3:", P3)
                            hlc1.go_to(P3[0], depth, P3[1], 0, 1, relative=False)
                            #hlc2.go_to(P3[0] + distance + 1, depth, P3[1], 0, 1, relative=False)
                            #hlc3.go_to(P3[0] + distance + 1, depth - distance - 1, P3[1], 0, 1, relative=False)
                            hlc4.go_to(P3[0], depth - distance - 1, P3[1], 0, 1, relative=False)
                            hlc5.go_to(P3[0] - distance - 1, depth - distance - 1, P3[1], 0, 1, relative=False)
                            hlc6.go_to(P3[0] - distance - 1, depth, P3[1], 0, 1, relative=False)
                            hlc7.go_to(P3[0] - distance - 1, depth + distance + 1, P3[1], 0, 1, relative=False)
                            hlc8.go_to(P3[0], depth + distance + 1, P3[1], 0, 1, relative=False)
                            #hlc9.go_to(P3[0] + distance + 1, depth + distance + 1, P3[1], 0, 1, relative=False)
                    ...
                    if fingers1 == [1, 1, 0, 0, 0]:
                        ...
                        hlc1.go_to(P3FinalX, depthFinal, P3FinalY, 0, 1, relative=False)
                        ...
                        hlc4.go_to(P3FinalX, depthFinal-distance-1, P3FinalY, 0, 1, relative=False)
                        hlc5.go_to(P3FinalX-distance-1, depthFinal-distance-1, P3FinalY, 0, 1, relative=False)   
                        hlc6.go_to(P3FinalX-distance-1, depthFinal, P3FinalY, 0, 1, relative=False) 
                        hlc7.go_to(P3FinalX-distance-1, depthFinal+distance+1, P3FinalY, 0, 1, relative=False)
                    ...
                    if fingers1 == [0,0,0,1,1]:
                        P3 = np.array([point3_x, 2 - point3_y])
                        print("P3:", P3)
                        #hlc2.go_to(P3[0]+.5, depth, P3[1], 0, 0.5, relative=False)
                    if fingers1 == [0,0,1,1,1]:
                        P3 = np.array([point3_x, 2 - point3_y])
                        print("P3:", P3)
                        #hlc3.go_to(P3[0]+1, depth, P3[1], 0, 0.5, relative=False)
